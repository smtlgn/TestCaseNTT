...
public class egitim01 {
    @Test
    public static <SelectElement> void main(String[] args) throws IOException, CsvValidationException, InterruptedException {

        CSVReader reader = new CSVReader(new FileReader("src/test/resources/sorma.csv"));
        String[] cell;
